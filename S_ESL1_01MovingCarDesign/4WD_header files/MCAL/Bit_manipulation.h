...
#define SET_LOW_NIBBLE_BITS(REG, DATA)      (REG = ((REG&0xF0)|(DATA&0x0F)))    /*set low nibbble of byte*/
#define SET_HIGH_NIBBLE_BITS(REG, DATA)     (REG = ((REG&0x0F)|(DATA&0xF0)))    /*set high nibbble of byte*/
