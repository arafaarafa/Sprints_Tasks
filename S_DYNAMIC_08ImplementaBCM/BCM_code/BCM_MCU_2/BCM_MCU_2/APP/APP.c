...
char data[BUFFER_MAX_SIZE]= "BCM Operating";
uint16_t data_length=14;
char packet_1[BUFFER_MAX_SIZE]= "Confirm BCM Operating";
uint16_t packet_1_length=22;
...
void app_run(void){
	...
	enu_transmit_or_receive_t transmit_or_receive = RECEIVE;
